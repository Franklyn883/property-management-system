   ...
   def get(self,request):
       ...
       try:
        ...
        return Response({
            ...
            "is_verified_poster":getattr(profile,"is_verified_poster",False),
        ...
        try:
            with transaction.atomic():
                ...
                if serializer.is_valid():
                    ...
                    validation_errors = self._validate_role_specific_data(request.user,serializer.validated_data)
    ...
    def _validate_role_specific_data(self,user,validated_data):
        ...
        if role == "agent":
            if "license_id" in validated_data and not validated_data["license_id"]:
                return {"license_id":["This field is required for agents"]}
            if 'agency_name' in validated_data and not validated_data["agency_name"]:
