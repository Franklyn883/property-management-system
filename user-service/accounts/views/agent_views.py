...
from ..utilities.user_utility import get_profile_for_user
from ..serializers.agent_serializers import (
...
class AgentLicenseViewSet(ViewSet):
    ...
    def update_license(self, request):
        ...
        serializer = AgentLicenseSerializer(profile, data=request.data, partial=True)
    ...
    def get_license_status(self, request):
        ...
        return Response({
            ...
            "data": {
                ...
                "is_license_valid": profile.license_expiration_date and profile.license_expiration_date > date.today(),
                "requires_renewal": profile.license_expiration_date and profile.license_expiration_date <= date.today() + timedelta(days=30),
            }
        }, status=status.HTTP_200_OK)
...
class AgentAgencyViewSet(ViewSet):
    ...
    def update_agency_info(self, request):
        ...
        serializer = AgentAgencySerializer(profile, data=request.data, partial=True)
...
class AgentStatsView(APIView):
    ...
    def get(self, request):
        ...
        license_stats = {
            ...
            "license_expired": profile.license_expiration_date and profile.license_expiration_date <= today,
            "license_expiring_soon": profile.license_expiration_date and profile.license_expiration_date <= today + timedelta(days=30),
            "days_until_expiration": stats_serializer.get_days_until_expiration(profile),
        }
