...
class OwnerPropertyViewSet(ViewSet):
    ...
    def update_property_info(self, request):
        ...
        serializer = OwnerPropertySerializer(profile, data=request.data, partial=True)
...
class OwnerAnalyticsView(APIView):
    ...
    def get(self, request):
        ...
        verification_days = analytics_serializer.get_days_since_verification(profile)
        
        # Property analytics
        property_stats = {
            "total_properties": profile.properties_owned_count,
            "has_properties": profile.properties_owned_count > 0,
            "property_range": self._get_property_range(profile.properties_owned_count),
        }
        ...
        document_stats = {
            ...
            "document_types": self._get_document_types(profile.ownership_documents),
            "completion_percentage": self._calculate_completion_percentage(documents_count),
        }
