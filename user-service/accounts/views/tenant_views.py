...
class TenantPreferenceViewSet(ViewSet):
    ...
    def update_preferences(self, request):
        ...
        serializer = TenantPreferenceSerializer(
...
class TenantHistoryViewSet(ViewSet):
    ...
    def get_history_stats(self, request):
        ...
        average_rent = (
            total_rent_paid / total_entries if total_entries > 0 else 0
        )
        ...
        average_duration_months = (
            total_duration_days / 30 if total_duration_days > 0 else 0
        )
...
class TenantRatingViewSet(ViewSet):
    ...
    def get_rating_breakdown(self, request):
        ...
        breakdown = {
            ...
            "average_rating": TenantRatingSerializer().get_average_rating(
                profile
            ),
        }

        return Response(
            {"status": "success", "data": breakdown}, status=status.HTTP_200_OK
        )
